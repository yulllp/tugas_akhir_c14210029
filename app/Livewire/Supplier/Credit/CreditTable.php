...
namespace App\Livewire\Supplier\Credit;
...
class CreditTable extends Component
{
    ...
    {
        $payments = CreditPurchase::query()
            ->where('purchase_id', $this->id)                // filter by that transaction
        ...
        return view('livewire.supplier.credit.credit-table', [
            'payments' => $payments,
        ]);
    }
}
