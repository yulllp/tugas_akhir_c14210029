...
$total = $transaction->total; // e.g. 4 000 000
$prePaid = $transaction->prePaid; // e.g. 1 500 000
...
<div id="pay-modal"
  ...
  <div class="relative w-full max-w-lg p-4 h-full md:h-auto">
    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
      ...
      <form action="{{ route('credit-payments.store', $transaction) }}" method="POST" class="p-4 space-y-4">
        @csrf
