                            ...
                            <div class="flex justify-center xl:justify-start">
                                <div class="inline-flex rounded-md shadow-sm overflow-hidden border border-gray-300 dark:border-gray-600">
                                    <button wire:click="$set('statusFilter', 'semua')"
                                        class="px-4 py-2 text-sm font-medium focus:outline-none transition-all {{ $statusFilter === 'semua' ? 'bg-blue-600 text-white' : 'bg-white text-gray-800 hover:bg-gray-100 dark:bg-gray-800 dark:text-gray-200 dark:hover:bg-gray-700' }}">
                                        All Transaction
                                    </button>
                                    <button wire:click="$set('statusFilter', 'paid')"
                                        class="px-4 py-2 text-sm font-medium border-l border-gray-300 dark:border-gray-600 focus:outline-none transition-all {{ $statusFilter === 'paid' ? 'bg-blue-600 text-white' : 'bg-white text-gray-800 hover:bg-gray-100 dark:bg-gray-800 dark:text-gray-200 dark:hover:bg-gray-700' }}">
                                        Paid
                                    </button>
                                    <button wire:click="$set('statusFilter', 'unpaid')"
                                        class="px-4 py-2 text-sm font-medium border-l border-gray-300 dark:border-gray-600 focus:outline-none transition-all {{ $statusFilter === 'unpaid' ? 'bg-blue-600 text-white' : 'bg-white text-gray-800 hover:bg-gray-100 dark:bg-gray-800 dark:text-gray-200 dark:hover:bg-gray-700' }}">
                                        Unpaid
                                    </button>
                                </div>
                            </div>
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3" wire:click="setSortBy('transaction_at')">Tanggal</th>
                        ...
                        <tbody>
                            ...
                            <tr wire:key="{{ $transaction->id }}" class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    {{ \Carbon\Carbon::parse($transaction->transaction_at)->format('d-m-Y H:i') }}
                                </td>
                                <td class="px-4 py-3">
                                ...
                                <td class="px-4 py-3">
                                    {{ number_format($transaction->prePaid, 0, ',', '.') }}
                                </td>
                                <td class="px-4 py-3">
