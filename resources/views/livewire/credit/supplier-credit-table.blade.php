                ...
                <div class="space-y-4">
                    <div class="flex flex-col space-y-4">
                        ...
                        <div class="w-full md:w-1/3">
                            <label for="supplierSelect" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                Pilih Supplier
                            </label>
                            <select
                                ...
                                <div class="relative">
                                    ...
                                    <input
                                        ...
                                        class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg
                                               ...
                                               dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
                                        placeholder="Cari ID pembelian atau nama supplier" />
                                </div>
                            </div>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            ...
                            $totalReturNominal = $pur
                            ->returs
                            ->flatMap(fn($r) => $r->items)
                            ->sum('subtotal');

                            // 2) Net total setelah retur
                            $netTotal = $pur->total - $totalReturNominal;
                            if ($netTotal < 0) {
                                $netTotal=0;
                                }
                                ...
                                if ($alreadyPaid < 0) {
                                    ...
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700" wire:key="{{ $pur->id }}">
                                        <!-- Index # -->
                                        ...
                                        <!-- Supplier -->
                                        <td class="px-4 py-3">{{ $pur->supplier->name ?? '-' }}</td>
                                    ...
                                    <tr>
                                        <td colspan="8" class="text-center px-4 py-6 text-gray-500 dark:text-gray-400">
                                            Tidak ada kredit pembelian (unpaid) untuk supplier ini.
                                        </td>
                                    </tr>
                                    @endforelse
                        </tbody>
